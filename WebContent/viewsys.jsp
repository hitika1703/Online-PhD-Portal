...
<%
	try{
		...
		ResultSet rs0= st.executeQuery("select student_name, student_id, project_name, evaluator_name, evaluator_id, suitability_score, originality_score, intro_bckgrnd_score from sys_eval where student_id='PHDTC19421'");
		while(rs0.next())
		{
%>
...
<%		
		ResultSet rs1= st.executeQuery("select Problem_stmt_score, design_method_score, relevancy_score, language_score, quantum_of_work_score, reference_score, overall_score, accept_word from sys_eval where student_id='PHDTC19421'");
		while(rs1.next())
		{
%>
...
<%		
		ResultSet rs2= st.executeQuery("select minor_revision, major_revision, reasons, comments from sys_eval where student_id='PHDTC19421'");
		while(rs2.next())
		{
%>
